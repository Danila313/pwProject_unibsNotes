                ...
                <div class="card-body p-4">
                    <div class="row text-black align-items-center">
                        ...
                        <div class="col-7">
                            ...
                            @else
                            <div class="row justify-content-between p-0 pt-2">
                                    <div class="col-10 p-0">
                                        <a href="{{ route('login') }}" type="button" role="button" class="btn btn-primary btn-block form-control" style="border-radius: 20px;">@lang('buttons.follow')</a>
                                    </div>
                                    <div class="col-2">
                                        <!-- Button trigger modal -->                                       
                                        <button type="button" class="btn btn-light btn-small" data-bs-toggle="modal" data-bs-target="#exampleModal">
